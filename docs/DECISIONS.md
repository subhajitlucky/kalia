...
| D21 | 2026-09-23 | Distillation (KALIA-D) presented as separate, clearly-labelled lineage; no decision yet | Silent distillation; reject outright | Biggest capability lever; ownership trade-off must be explicit | pending decision |
